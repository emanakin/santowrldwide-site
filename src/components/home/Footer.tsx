...
const Footer = () => {
  ...
  const handleNewsletterSubmit = async (email: string, phone?: string) => {
    try {
      ...
      // Success is handled by the popup component
    } catch (error) {
      console.error("Newsletter subscription error:", error);
      throw error; // Re-throw to let popup handle the error display
    }
  };
    ...
    <>
      <footer className={styles.footer}>
        ...
        <div className={styles.socialContainer}>
          <Link
            href="https://www.instagram.com/santowrldwide/"
            target="_blank"
          ...
          <Link
            href="https://www.tiktok.com/@santowrldwide"
            target="_blank"
            rel="noopener noreferrer"
            className={styles.socialLink}
          >
